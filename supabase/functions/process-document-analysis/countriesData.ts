...
function getGoverningBodyByCountry(countryName: string) {
    const country = DRESSAGE_COUNTRIES_DATA.find(c => c.country === countryName);
    return country ? country.governingBody : null;
}

function getLevelsByCountry(countryName: string) {
    const country = DRESSAGE_COUNTRIES_DATA.find(c => c.country === countryName);
    return country ? country.levels : [];
}

function getLevelsByGoverningBody(abbreviation: string) {
