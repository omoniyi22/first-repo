...
const Index = () => {
  ...
  const featuredJumpingPost = blogPosts.find(
    (post) => post.discipline === "Jumping"
  );
  const featuredDressagePost = blogPosts.find(
    (post) => post.discipline === "Dressage"
  );
              ...
              <div className="grid md:grid-cols-2 h-full">
                ...
                <div className="relative w-full h-full">
                  ...
                  <img
                    ...
                    className={`absolute inset-0 w-full h-full object-cover transition-opacity duration-700 ${
                      jumpingImageLoaded ? "opacity-100" : "opacity-0"
                    }`}
                ...
                <div className="relative w-full h-full hidden md:block">
                  ...
                  <img
                    ...
                    className={`absolute inset-0 w-full h-full object-cover transition-opacity duration-700 ${
                      dressageImageLoaded ? "opacity-100" : "opacity-0"
                    }`}
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-white/90 mb-4 max-w-2xl mx-auto text-shadow-sm">
                {language === "en"
                  ...
                  : "Soluciones avanzadas de IA para el entrenamiento, el análisis y la mejora del rendimiento ecuestre"}
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto mb-8">
                <div className="bg-white/10 backdrop-blur-md rounded-xl p-5 sm:p-8 border border-white/20 hover:bg-white/20 transition-all transform hover:-translate-y-1 group">
                  <h2 className="text-xl sm:text-2xl font-serif font-medium text-white mb-3 sm:mb-4">
                    {language === "en"
                      ? "AI Dressage Trainer"
            ...
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-serif font-medium mb-6 text-purple-900">
                {language === "en"
                  ...
                  : "¿Por qué elegir AI Equestrian?"}
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                {language === "en"
                  ? "Our AI-powered platform offers unique solutions for both dressage and jumping disciplines"
                  : "Nuestra plataforma impulsada por IA ofrece soluciones únicas tanto para disciplinas de doma como de salto."}
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    language === "en"
                      ? "Get customized training recommendations based on your performance data and goals."
                      : "Obtén recomendaciones de entrenamiento personalizadas basadas en tus datos de rendimiento y objetivos.",
                },
                {
                  title:
                    language === "en"
                  ...
                  description:
                    language === "en"
                      ? "AI-powered insights that identify patterns and improvement opportunities in your riding."
                      : "Insights impulsados por IA que identifican patrones y oportunidades de mejora en tu conducción.",
                },
                {
                  title:
                    language === "en"
                  ...
                  description:
                    language === "en"
                      ? "Monitor your advancement over time with detailed metrics and visual progress reports."
                      : "Monitorea tu avance a lo largo del tiempo con métricas detalladas y reportes visuales de progreso.",
                },
              ].map((benefit, index) => (
                <div
                  key={index}
                ...
                >
                  <h3 className="text-xl font-serif font-medium mb-4 text-purple-900">
                    {benefit.title}
                  </h3>
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                {language === "en"
                  ...
                  : "Manténgase actualizado con las últimas ideas, consejos y noticias del mundo ecuestre."}
              </p>
            </div>
                    ...
                    <div className="col-span-2 text-center py-10">
                      <p className="text-gray-500">
                        {language === "en"
                          ...
                          : "No se encontraron entradas del blog. ¡Vuelve pronto para ver las novedades!"}
                      </p>
                    </div>
                  )}
                </>
