        ...
        <section className="py-16 bg-purple-50">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center mb-12 reveal-scroll">
              <h2 className="text-3xl md:text-4xl font-serif font-semibold mb-4 text-blue-900">Partnerships & Sponsorships</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto reveal-scroll">
              ...
              <Card className="border border-purple-200 bg-white">
                <CardHeader className="pb-2">
                  <CardTitle className="text-xl text-center font-serif text-blue-800">Equestrian Federation</CardTitle>
                </CardHeader>
                <CardContent className="text-center">
                  <p className="text-blue-600 mb-4">Official technology partner providing AI training solutions to national team riders.</p>
              ...
              <Card className="border border-purple-200 bg-white">
                <CardHeader className="pb-2">
                  <CardTitle className="text-xl text-center font-serif text-blue-800">Elite Equine Equipment</CardTitle>
                </CardHeader>
                <CardContent className="text-center">
                  <p className="text-blue-600 mb-4">Premium equipment manufacturer partnering to integrate technology with traditional training tools.</p>
                  <div className="h-20 w-20 bg-purple-100 rounded-full mx-auto flex items-center justify-center">
                    <span className="text-blue-400">Logo</span>
                  </div>
                </CardContent>
              ...
              <Card className="border border-purple-200 bg-white">
                <CardHeader className="pb-2">
                  <CardTitle className="text-xl text-center font-serif text-blue-800">International Shows Circuit</CardTitle>
                </CardHeader>
                <CardContent className="text-center">
                  <p className="text-blue-600 mb-4">Official AI analysis partner for major international competitions and events.</p>
                  <div className="h-20 w-20 bg-purple-100 rounded-full mx-auto flex items-center justify-center">
                    <span className="text-blue-400">Logo</span>
                  </div>
                </CardContent>
            ...
            <div className="mt-12 text-center reveal-scroll">
              <h3 className="text-xl font-medium mb-4 text-purple-800">Interested in partnering with AI Equestrian?</h3>
