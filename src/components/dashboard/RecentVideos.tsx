  ...
  const videos = [
    {
      id: 1,
      title:
        language === "en" ? "First Level Test 3" : "Prueba de Nivel Primero 3",
      date: "2023-04-15",
    ...
    },
    {
      ...
      title:
        language === "en"
          ...
          : "Prueba de Nivel de Entrenamiento 2",
      date: "2023-03-22",
    ...
    },
    {
      id: 3,
      title:
        language === "en" ? "Second Level Test 1" : "Prueba de Nivel Segundo 1",
      date: "2023-02-10",
  ...
  return (
    <div className="mt-6 sm:mt-8 lg:mt-0">
      <div className="flex justify-between items-center mb-3 sm:mb-4">
        ...
        <Button
          variant="link"
          className="text-purple-700 text-sm sm:text-base p-0 h-auto"
        >
            ...
            <div className="p-3 sm:p-4 flex-1">
              ...
              <div className="mt-3 sm:mt-4 flex flex-wrap gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  className="text-xs sm:text-sm text-gray-700 border-gray-200 hover:bg-gray-50 hover:text-gray-800 h-8"
                >
