  ...
  const faqs =
    language === "en"
      ...
      : [
          {
            question:
              "¿Qué tan preciso es el análisis de IA de las hojas de puntuación?",
            answer:
              "Nuestro sistema de IA ha sido entrenado con miles de pruebas de doma y ha alcanzado más del 98% de precisión en la lectura e interpretación de hojas de puntuación. El sistema está continuamente aprendiendo y mejorando con cada nueva hoja de puntuación procesada.",
          },
          {
            question: "¿Qué formatos de prueba de doma son compatibles?",
            answer:
              "Admitimos todos los formatos principales de pruebas de doma, incluidos FEI, USDF, British Dressage, Equestrian Australia y muchos otros. Si tienes un formato específico que no está en la lista, contáctanos y trabajaremos para agregar soporte para él.",
          },
          {
            question: "¿Cómo subo mis hojas de puntuación?",
            answer:
              "Puedes tomar una foto de tu hoja de puntuación usando tu smartphone o subir una copia digital (PDF, JPEG, PNG). Nuestro sistema procesará y analizará automáticamente la hoja independientemente del formato.",
          },
          {
            question: "¿Puedo seguir varios caballos en mi cuenta?",
            answer:
              "Sí, nuestros planes Premium y Profesional te permiten crear y seguir múltiples perfiles de caballos. Esto te permite gestionar y analizar el progreso de diferentes caballos por separado.",
          },
          {
          ...
          {
            question:
              "¿Con qué frecuencia debo cargar nuevas hojas de puntuación?",
            answer:
              "Para obtener los mejores resultados, te recomendamos cargar cada nueva prueba que montes, ya sea de competiciones o sesiones de entrenamiento. Esto proporciona los datos más completos para que nuestra IA analice tendencias y progresos a lo largo del tiempo.",
          },
        ];
    ...
    <section className="py-20 bg-silver-50">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-700">{t["faq-description"]}</p>
        </AnimatedSection>
          ...
          >
            {faqs.map((faq, index) => (
              <AccordionItem
                key={index}
                value={`item-${index}`}
                className="border-b border-silver-200 last:border-b-0"
              >
