    ...
    <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
      ...
      <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-2xl overflow-hidden shadow-lg text-white">
        <div className="p-8">
          ...
          <p className="mb-6 text-white">Transform your dressage performance with AI-powered analysis of test scores, videos, and receive personalized training recommendations.</p>
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-start gap-3">
              ...
              <p className='text-white'>Upload dressage test videos or score sheets</p>
            </div>
            <div className="flex items-start gap-3">
              ...
              <p className='text-white'>Receive detailed AI analysis of movements and transitions</p>
            </div>
            <div className="flex items-start gap-3">
              ...
              <p className='text-white'>Follow personalized training recommendations</p>
            </div>
          </div>
          
          <div className="flex flex-col items-center gap-4">
            <Button variant="secondary" className="w-full bg-white hover:bg-gray-100 text-purple-700">
      ...
      <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl overflow-hidden shadow-lg text-white">
        <div className="p-8">
          ...
          <p className="mb-6 text-white">Elevate your jumping performance with AI-powered video analysis, course insights, and personalized training recommendations.</p>
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-start gap-3">
              ...
              <p className='text-white' >Upload videos of your jumping rounds or training sessions</p>
            </div>
            <div className="flex items-start gap-3">
              ...
              <p className='text-white' >Get analyzed insights on approach, takeoff, and landing</p>
            </div>
            <div className="flex items-start gap-3">
              ...
              <p className='text-white' >Implement targeted exercises to improve technique</p>
            </div>
          </div>
          
          <div className="flex flex-col items-center gap-4">
            <Button variant="secondary" className="w-full bg-white hover:bg-gray-100 text-blue-700">
              Start Your Free Trial
            </Button>
