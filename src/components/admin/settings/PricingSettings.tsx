                ...
                <div className="flex items-center space-x-2">
                  <Switch 
                    ...
                    onCheckedChange={(checked) => 
                      setEditingPlan({...editingPlan, is_highlighted: checked})
                    }
                  />
                  <span>
                    {editingPlan.is_highlighted ? 'Featured Plan' : 'Regular Plan'}
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  onChange={(e) => setEditingPlan(
                    {...editingPlan, monthly_price: parseFloat(e.target.value)}
                  )}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  onChange={(e) => setEditingPlan(
                    {...editingPlan, annual_price: parseFloat(e.target.value)}
                  )}
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  onChange={(e) => setEditingPlan({...editingPlan, tagline_en: e.target.value})}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  onChange={(e) => setEditingPlan({...editingPlan, tagline_es: e.target.value})}
                />
              </div>
            </div>
                    ...
                    <TableRow key={feature.id}>
                      <TableCell>
                        <Input 
                          ...
                          onChange={(e) => updateFeatureValue(feature.id, 'text_en', e.target.value)}
                        />
                      </TableCell>
                      <TableCell>
                        <Input 
                          value={feature.text_es} 
                          onChange={(e) => updateFeatureValue(feature.id, 'text_es', e.target.value)}
                        />
                      </TableCell>
                      <TableCell>
                        <Switch 
              ...
              <div className="mt-4 border-t pt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-2">
                  <Input 
                    ...
                    onChange={(e) => setNewFeatureText({...newFeatureText, en: e.target.value})}
                  />
                  <Input 
                    placeholder="Feature text (Spanish)" 
                    value={newFeatureText.es}
                    onChange={(e) => setNewFeatureText({...newFeatureText, es: e.target.value})}
                  />
                </div>
            ...
            <TabsList className="mb-4">
              {plans.map((plan) => (
                <TabsTrigger key={plan.id} value={plan.id}>
                  {plan.name} {plan.is_highlighted && '(Featured)'}
                </TabsTrigger>
              ))}
            </TabsList>
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        £{plan.monthly_price}/mo (monthly) · £{plan.annual_price}/mo (annual)
                      </p>
