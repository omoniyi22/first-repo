  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? "bg-purple-950/90 backdrop-blur-md shadow-md"
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <Link to="/" className="flex items-center">
              ...
              {!isMobile && (
                <h1
                  className={`font-serif text-xl font-semibold ${getBrandColorClass()}`}
                >
                  {getBrandName()}
                </h1>
              )}
              ...
              <div className="flex items-center ml-3 space-x-4">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger className="flex items-center text-white focus:outline-none">
                    ...
                    <span className="hidden lg:inline-block font-sans text-sm">
                      {user.email?.split("@")[0]}
                    </span>
                  </DropdownMenuTrigger>
                  <DropdownMenuContent
                  ...
                  >
                    ...
                    <DropdownMenuItem
                      ...
                      className="cursor-pointer text-red-600 font-sans text-sm px-2.5 py-1.5 rounded-sm"
                    >
        ...
        <div className="md:hidden bg-purple-950/95 shadow-lg animate-fade-in">
          <nav className="container mx-auto px-6 py-4 flex flex-col space-y-4">
            ...
            <Link
              to="/pricing"
              className={`text-white text-base font-medium font-sans ${
                isActive("/pricing") ? "text-purple-300" : ""
              }`}
            >
              {t["pricing"]}
            </Link>
            ...
            <Link
              to="/about"
              className={`text-white text-base font-medium font-sans ${
                isActive("/about") ? "text-purple-300" : ""
              }`}
            >
              {t["about"]}
            </Link>
            ...
            {user && (
              <>
                <Link
                  to="/dashboard"
                  className={`text-white text-base font-medium font-sans ${
                    isActive("/dashboard") ? "text-purple-300" : ""
                  }`}
                >
                  {t["dashboard"]}
                </Link>
                <Link
                  to="/profile-setup"
                  className={`text-white text-base font-medium font-sans ${
                    isActive("/profile-setup") ? "text-purple-300" : ""
                  }`}
                >
                  {t["profile-setup"]}
                </Link>
