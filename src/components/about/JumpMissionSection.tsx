...
const JumpMissionSection = () => {
  return (
    <section className="py-24 bg-white">
      <div className="container mx-auto px-6">
        <AnimatedSection animation="fade-in" className="text-center max-w-3xl mx-auto mb-16">
          <h1 className="text-4xl md:text-5xl font-serif font-semibold text-blue-900 mb-6">
            About AI Jump Trainer
          </h1>
          <p className="text-lg text-blue-700">
            We're on a mission to transform jumping training through the power of artificial intelligence.
          </p>
        </AnimatedSection>
        
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          <AnimatedSection animation="fade-in-right">
            <div className="aspect-square bg-blue-50 rounded-2xl overflow-hidden relative">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-blue-800/10" />
              <div className="w-full h-full bg-blue-100/50 flex items-center justify-center">
                <div className="text-center">
                  <span className="font-serif text-3xl text-blue-800">Our Vision</span>
                </div>
              </div>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection animation="fade-in">
            ...
            <div className="space-y-6 text-blue-700">
              <p>
                At AI Jump Trainer, we believe that technology can enhance the time-honored tradition of jump training. Our mission is to democratize access to elite-level jumping education by leveraging artificial intelligence to provide personalized, data-driven insights to riders of all levels.
              </p>
              
              <p>
                We envision a world where every jumping rider, regardless of location or resources, can receive tailored guidance to improve their performance and strengthen the partnership with their horse.
              </p>
              
              <p>
                Our platform was born from a simple observation: while competition rounds provide valuable experience, riders often struggle to identify specific areas for improvement and develop effective training strategies. By harnessing the power of AI, we bridge that gap, turning competition results and video analysis into actionable training plans.
              </p>
            </div>
          </AnimatedSection>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6 text-blue-700">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span>Competition feedback is limited and often fails to identify specific areas for improvement</span>
                </li>
                ...
                <li className="flex items-start">
                  ...
                  <span>Many riders have limited access to high-quality coaching and structured course analysis</span>
                </li>
                ...
                <li className="flex items-start">
                  <span className="inline-flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full text-blue-700 font-medium mr-3 mt-0.5">4</span>
                  <span>Translating round results into effective training exercises requires deep expertise</span>
                </li>
              </ul>
          ...
          <AnimatedSection animation="fade-in-left" className="order-1 lg:order-2">
            <div className="aspect-square bg-blue-50 rounded-2xl overflow-hidden relative">
              ...
              <div className="w-full h-full bg-blue-100/50 flex items-center justify-center">
                <div className="text-center">
                  <span className="font-serif text-3xl text-blue-800">Our Approach</span>
                </div>
              </div>
            </div>
          </AnimatedSection>
        ...
        <AnimatedSection animation="fade-in" delay="delay-200" className="mt-20">
          <div className="bg-blue-800 rounded-2xl overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-0.5 bg-blue-700">
              ...
              <div className="bg-blue-800 p-8 text-center">
                ...
                <div className="text-blue-200">Rounds Analyzed</div>
              </div>
            ...
            <div className="p-8 md:p-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-blue-200 text-sm">Pushing the boundaries of what's possible in jump training</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-blue-200 text-sm">Delivering accurate, reliable analysis and recommendations</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-blue-200 text-sm">Building a supportive network of riders and trainers</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-blue-200 text-sm">Respecting classical principles while embracing technology</p>
                </div>
              </div>
            </div>
          </div>
...
export default JumpMissionSection;
