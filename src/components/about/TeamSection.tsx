  ...
  const teamMembers: TeamMember[] = [
    {
      ...
      role: "Founder & CEO",
      bio: "Former international dressage competitor with a PhD in Computer Science from MIT. Eleanor combined her passion for dressage and expertise in artificial intelligence to create a revolutionary training platform.",
