...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden pt-24"> {/* Increased pt-24 for more navbar space */}
      ...
      <div className="container relative z-10 mx-auto px-6 text-center mt-10"> {/* Adjusted mt-10 for better spacing */}
