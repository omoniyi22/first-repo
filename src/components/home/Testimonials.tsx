                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-purple-200 text-sm">Upload your score sheets for instant AI-powered feedback</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-purple-200 text-sm">Get tailored exercises based on your specific needs</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-purple-200 text-sm">Monitor your improvement with detailed analytics</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-purple-200 text-sm">Access to 200+ dressage training exercises</p>
                    </div>
                  </div>
                </div>
              </div>
